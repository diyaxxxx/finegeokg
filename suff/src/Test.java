...
public class Test {//filter未分离版本
    ...
    static MyBloomFilter dataFilter3;
    static MyBloomFilter dataFilter4;
    static MyBloomFilter queryFilter3;
    static MyBloomFilter queryFilter4;
    //深度优先查找、回溯
...
//            System.out.println("q.get(n):"+q.get(n));
    ...
    public static void main(String[] args) throws IOException {
        ...
        String dataEdge = "C:\\Users\\14097\\Desktop\\postgra\\ustb\\suff\\dataEdge.txt";
        ...
        String queryEdge = "C:\\Users\\14097\\Desktop\\postgra\\ustb\\suff\\queryEdge.txt";
        ...
        GetFilter getDataFilter3 = new GetFilter(3);
        getDataFilter3.dfs(dataGraph);
        dataFilter3 = getDataFilter3.getMbf();
        System.out.println("hh"+dataFilter3.contains(6));

        GetFilter getDataFilter4 = new GetFilter(4);
        getDataFilter4.dfs(dataGraph);
        dataFilter4 = getDataFilter4.getMbf();
        System.out.println("hh"+dataFilter4.contains(6));

        long middle = System.currentTimeMillis();
        GetFilter getQueryFilter3 = new GetFilter(3);
        getQueryFilter3.dfs(queryGraph);
        queryFilter3 = getQueryFilter3.getMbf();
        System.out.println("hh"+queryFilter3.contains(5));

        GetFilter getQueryFilter4 = new GetFilter(4);
        getQueryFilter4.dfs(queryGraph);
        queryFilter4 = getQueryFilter4.getMbf();
        System.out.println("hh"+queryFilter4.contains(5));
